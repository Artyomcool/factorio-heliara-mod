...
local _silo_base_img = "__heliashade__/graphics/entity/space_platform_silo/space_platform_silo_A_base.png"
local _silo_shadow_img = "__heliashade__/graphics/entity/space_platform_silo/space_platform_silo_A_shadow.png"
local _silo_front_img = "__heliashade__/graphics/entity/space_platform_silo/space_platform_silo_A_front.png"
local _rocket_img = "__heliashade__/graphics/entity/space_platform_silo/space_platform_rocket.png"
...
local blueprint_tool_proto = wrap_for_data(
    function()
        return {
            ...
            icon = "__heliashade__/graphics/icons/platform_replicator_blueprint.png",
            icon_size = 64,
...
local platform_blueprint_proto = wrap_for_data(
    function()
        ...
        blueprint.icon = "__heliashade__/graphics/icons/platform_replicator_blueprint.png"
...
local blueprint_tool_shortcut_proto = wrap_for_data(
    function()
        return {
            ...
            icon = "__heliashade__/graphics/icons/platform_replicator_blueprint.png",
            icon_size = 64,
            small_icon = "__heliashade__/graphics/icons/platform_replicator_blueprint.png",
            small_icon_size = 64,
        }
    end
)
