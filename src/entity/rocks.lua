        ...
        entity = {
            ...
            minable = {
                ...
                results = {
                    ...
                    { type = "item", name = "stone", amount_min = 50, amount_max = 50 },
                    { type = "item", name = "iron-ore", amount_min = 50, amount_max = 50 },
                    { type = "item", name = "iron-plate", amount_min = 100, amount_max = 100 },
                    { type = "item", name = "steel-plate", amount_min = 100, amount_max = 100 },
                    { type = "item", name = "fullerene", amount_min = 100, amount_max = 100 },
                    { type = "item", name = "fullerene_extraction_bath", amount_min = 5, amount_max = 5 },
                    { type = "item", name = "fullerene_solar_panel", amount_min = 5, amount_max = 5 },
                    { type = "item", name = "graphite", amount_min = 50, amount_max = 50 },
                    { type = "item", name = "graphite_circuit", amount_min = 50, amount_max = 50 },
                    { type = "item", name = "heliara_assembling_machine", amount_min = 5, amount_max = 5 },
                    { type = "item", name = "shungite", amount_min = 50, amount_max = 50 },
                    { type = "item", name = "silicon_substrate", amount_min = 50, amount_max = 50 },
                    { type = "item", name = "solar_refractor_silo", amount_min = 1, amount_max = 1 },
                },
            },
