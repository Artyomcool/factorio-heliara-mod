...
data:extend({
    ...
    },
    {
        ...
        icon = "__heliara__/graphics/icons/fullerene_solar_panel_tech.png",
        icon_size = 256,
        essential = true,
    ...
    {
        type = "technology",
        name = "solar_reflector",
        icon = "__heliara__/graphics/icons/solar_reflector.png",
        icon_size = 1024,
        essential = true,
        effects = recipes("solar_reflector", "steam_rocket_silo"),
        prerequisites = { "graphite-automation-science-pack", "graphite-logistic-science-pack", "silcrete" },
    ...
    },
    {
        type = "technology",
        name = "steam_cargo",
        icon = "__heliara__/graphics/icons/steam_rocket_silo.png",
        icon_size = 64,
        essential = true,
        effects = recipes("steam_cargo"),
        prerequisites = { "osmosis_pipejack", "fullerene_rocket_fuel", "solar_reflector" },
        unit = unit(2000, 60,
            "automation",
            "logistic",
            "production",
