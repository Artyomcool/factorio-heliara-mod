...
return {
    {
        common = {
            name = _name,
            icon = "__packed-roboport__/graphics/icons/" .. _name .. ".png",
            icon_size = 128,
        ...
        entity = {
            ...
            sprite =
            {
                filename = "__packed-roboport__/graphics/icons/" .. _name .. ".png",
                width = 128,
                height = 128,
                priority = "medium",
            },
    ...
    },
    {
        recipe = {
            ...
            icon = "__packed-roboport__/graphics/icons/packed_roboport_unpack.png",
            icon_size = 64,
            subgroup = "utility-equipment",
